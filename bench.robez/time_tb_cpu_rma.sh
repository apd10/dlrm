...
$dlrm_pt_bin --is-rma --rma-size 2700000 --rma-chunk-size 32  --arch-sparse-feature-size=128 --arch-mlp-bot="13-512-256-128" --arch-mlp-top="1024-1024-512-256-1"  --max-ind-range=-1 --data-generation=dataset --data-set=terabyte --raw-data-file=./input/day --processed-data-file=./input/terabyte_processed.npz --loss-function=bce --round-targets=True --learning-rate=1.0  --mini-batch-size=2048 --print-freq=1 --print-time --test-freq=10 --test-mini-batch-size=128 --test-num-workers=16 $dlrm_extra_option --mlperf-logging --mlperf-bin-loader --mlperf-bin-shuffle --memory-map --dataset-multiprocessing  --nepochs 3  --mlperf-auc-threshold=0.8025  2>&1 | tee run_tb_cpu_rma_test.log
